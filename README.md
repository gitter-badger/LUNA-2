...
```diff
- HEADS-UP: Code rewrite in progress. Some of the code is ancient, from simpler times. None of the renovations should break anything, but in case it does please let me know.
```
